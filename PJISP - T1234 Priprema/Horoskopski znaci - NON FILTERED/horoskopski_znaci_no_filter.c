...
unsigned process_data(struct licnost_st *, struct horoskop_st *, unsigned, const unsigned);
unsigned hor_znak(const unsigned, const unsigned, char *);
...
int main(int argc, char **argm)
{
    ...
    j = process_data(licnosti, horoskopi, konvertovano, n);
...
unsigned process_data(struct licnost_st *licnosti, struct horoskop_st *horoskopi, unsigned uneto, const unsigned n) {
    unsigned i, j = 0;
    char tmp[15];
    for(i = 0; i < n; i++) {
        unsigned konvertovano = hor_znak(licnosti[i].danR, licnosti[i].mesecR, tmp);
...
unsigned hor_znak(const unsigned danR, const unsigned mesecR, char *znak) 
{
    if( (mesecR == 3   && danR >= 21)  || (mesecR == 4   && danR <= 20) ) strcpy(znak, "ovan");     // 21.3  -> 20.4
    if( (mesecR == 4   && danR >= 21)  || (mesecR == 5   && danR <= 21) )  strcpy(znak, "bik");      // 21.4  -> 21.5
    if( (mesecR == 5   && danR >= 22)  || (mesecR == 6   && danR <= 21) ) strcpy(znak, "blizanci"); // 22.5  -> 21.6
    if( (mesecR == 6   && danR >= 22)  || (mesecR == 7   && danR <= 22) )  strcpy(znak, "rak");      // 22.6  -> 22.7
    if( (mesecR == 7   && danR >= 23)  || (mesecR == 8   && danR <= 22) )  strcpy(znak, "lav");      // 23.7  -> 22.8
    if( (mesecR == 8   && danR >= 23)  || (mesecR == 9   && danR <= 22) ) strcpy(znak, "devica");   // 23.8  -> 22.9
    if( (mesecR == 9   && danR >= 23)  || (mesecR == 10  && danR <= 23) ) strcpy(znak, "vaga");     // 23.9  -> 23.10
    if( (mesecR == 10  && danR >= 24)  || (mesecR == 11  && danR <= 22) )  strcpy(znak, "skorpija"); // 24.10 -> 22.11
    if( (mesecR == 11  && danR >= 23)  || (mesecR == 12  && danR <= 21) )  strcpy(znak, "strelac");  // 23.11 -> 21.12
    if( (mesecR == 12  && danR >= 22)  || (mesecR == 1   && danR <= 20) )  strcpy(znak, "jarac");    // 22.12 -> 20.1
    if( (mesecR == 1   && danR >= 21)  || (mesecR == 2   && danR <= 19) )  strcpy(znak, "vodolija"); // 21.1  -> 19.2
    if( (mesecR == 2   && danR >= 20)  || (mesecR == 3   && danR <= 20) )  strcpy(znak, "ribe");     // 20.2  -> 20.3
}
